  ...
  return (
    <div className=" h-screen bg-customGray flex flex-row center">
      <div
        ...
        style={{ width: "100%", height: "70px", background: "rgba(255, 255, 255, 0.5)", position: "fixed", paddingTop: "10px", zIndex: "2",  backdropFilter: "blur(5px)", paddingBottom: "6px"}}
      >
        ...
        <h1 style={{fontFamily: "tkt", marginLeft: "80px", fontSize: "22px"}}>მთავარი</h1>
      </div>
      <div className="flex">
        <Sidebar/>
      </div>
      <div className="style_for_home" style={{display: "flex", justifyContent: "center", width: "100%", height: "1080px", paddingLeft: "250px"}}>
      <div
        style={{
          display: "flex",
