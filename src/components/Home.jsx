...
import SliderToogle from "./SliderToogle.jsx"
>>>>>>> Stashed changes
    ...
    <div className=" h-screen bg-customGray flex flex-row center">
      ...
      >
        ...
        <div style={{
          ...
          <h1
            style={{ fontFamily: "tkt", marginLeft: "80px", fontSize: "22px" }}
          >
            მთავარი
          </h1>
          <div>
...
<<<<<<< Updated upstream
        <h1 style={{margin: '80px', fontFamily: "tkt", fontSize: "22px", alignItems: "center"}}>მთავარი</h1>
=======
>>>>>>> Stashed changes
      </div>
      <div className="flex">
