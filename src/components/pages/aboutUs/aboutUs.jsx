...
import firstphoto from "../aboutUs/photo/first_photo.svg";
import gigi from "../aboutUs/photo/gigi.svg";
import duda from "../aboutUs/photo/duda.svg";
import me from "../aboutUs/photo/me.svg";
import gulo from "../aboutUs/photo/gulo.svg";
import yazo from "../aboutUs/photo/yazo.svg";
import AOS from "aos";
...
export default function AboutUs() {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      if (isInViewport(groupRef.current)) {
        AOS.refresh();
  ...
  return (
    <div className="h-screen bg-customGray flex flex-row center">
      ...
      >
        ...
        <h1 style={{ fontFamily: "tkt", marginLeft: "80px", fontSize: "22px" }}>
          ჩვენ შესახებ
        </h1>
      </div>
      <Sidebar />

      <div className="abUs-container-Main">
        <div className="abUs-container">
          <div className="oriwami">
            ...
            <div className="abUs-content">
                ...
                <div className="inner-content">
                  ...
                  <div className="photo-text">
                    ...
                    >
                      ...
                      ამაღლებას სხვადასხვა უნივერსიტეტების საქმიანობაზე.
                      UNISTATS-ზე შესაძლებელია გაეცნოთ უნივერსიტეტებისა და
                      სტუდენტების სტატისტიკებს ისეთ საკითხებზე, როგორიცაა:
                      დასაქმების მაჩვენებელი, გაცვლით პროგრამებზე გაშვებული
                      სტუდენტები, სტუდენტთა GPA და ა.შ.
                    </p>
                    <img
                      src={firstphoto}
                      alt=""
              ...
              <div
                className="purple-cont"
                data-aos="fade-up"
                data-aos-duration="500"
              >
                <h1>ჩვენი მიზანი</h1>
                <p>
                  ჩვენი ჯგუფი დაინეტერესებულია, რომ გავუმარტივოთ არჩევნის
                  გაკეთება აბიტურიენტებს უნივერსიტეტის არჩევაში, ასევე
                  დავეხმაროთ სტუდენტებს დასაქმებასა და ფართო ბაზარზე გამოჩენაში.
                  UNISTATS-ის იდეის დაბადებასთანავე ჩვენთვის მნიშვნელოვანი იყო,
                  რომ შეგვექმნა და გაგვეძლიერებინა კონკურენცია უნივერსიტეტებს
                  შორის, რათა მათ მეტად იზრუნონ უნივერსიტეტებზე და სტუდენტებზე.
                </p>
                <h1>ჩვენი ღირებულებები</h1>
                <p>
                  ჩვენი ჯგუფი დაინეტერესებულია, რომ გავუმარტივოთ არჩევნის
                  გაკეთება აბიტურიენტებს უნივერსიტეტის არჩევაში, ასევე
                  დავეხმაროთ სტუდენტებს დასაქმებასა და ფართო ბაზარზე გამოჩენაში.
