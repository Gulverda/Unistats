      ...
      >
        ...
        >
          ...
          <g mask="url(#mask1_74_36)">
            ...
            <Sidebar />
            <div className="for_map" style={{ padding: '20px', marginTop: "70px", marginLeft: "250px", }}>
                {/* Search input field */}
                <input
                    type="text"
                    ...
                    style={{ padding: '10px', width: '100%', boxSizing: 'border-box', borderRadius: '10px' }}
                />
                ...
                <div className="for_map_button" style={{ margin: '10px 0', maxWidth: "350px", width: '50%'}}>
                    {regions.map((region) => (
                        <button
                            key={region}
                            ...
                            style={{
                                ...
                                marginRight: '10px',
                                marginTop: '10px',
                                backgroundColor: selectedRegion === region ? '#DFD8FF' : '#fff',
                                color: selectedRegion === region ? '#4318FF' : '#7e52ef',
                                border: selectedRegion === region ? '1px solid #4318FF' : 'none',
                            }}
                        >
                            {region}
                        </button>
                    ...
                    <button
                        ...
                        style={{
                            padding: '10px',
                            marginTop: '10px',
                                backgroundColor: selectedRegion === '' ? '#DFD8FF' : '#fff',
                                color: selectedRegion === '' ? '#4318FF' : '#7e52ef',  
                                border: selectedRegion === '' ? '1px solid #4318FF' : 'none',
                                transition: selectedRegion === '' ? '0.5s' : '0.5s'
                            }}
                    >
                        All Regions
                    </button>
