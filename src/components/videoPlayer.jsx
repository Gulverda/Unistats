...
export default function VideoPlayer() {
  ...
  return (
    <div className="relative">
      <video controls className="absolute top-0 left-0 w-full h-full object-cover rounded-xl z-0">
        <source src={video}  type="video/mp4"/>
      </video>
      <img src={photo} alt="Banner Photo" className="w-default h-auto bg-cover rounded-xl z-10"/>
